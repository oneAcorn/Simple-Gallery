...
LUCKY ME
Feeling lucky? Tap the floating action button at the bottom right corner to randomly select a picture from your gallery and relive those special moments.

PRIVATE MODE
Safeguard your private photos and videos with the new Private Mode. To use it, select a folder containing the images you want to hide, tap the more options menu, and choose "Move to private folder". Then navigate to Settings, tap "Unlock password", enter your password, and you'll enter Private Mode, where you can view and manage your hidden albums securely.
